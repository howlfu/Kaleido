...
#ifndef KALEIDO_SWIFT_H
#define KALEIDO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Kaleido",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Kaleido11AppDelegate")
...
SWIFT_CLASS("_TtC7Kaleido18BaseViewController")
...
SWIFT_CLASS("_TtC7Kaleido18MainViewController")
@interface MainViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified recordButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified showButton;
...
- (IBAction)recordAction:(id _Nonnull)sender;
- (IBAction)showAction:(id _Nonnull)sender;
- (IBAction)storeAction:(id _Nonnull)sender;
- (IBAction)settingAction:(id _Nonnull)sender;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7Kaleido24RecordMainViewController")
@interface RecordMainViewController : BaseViewController
...
SWIFT_CLASS("_TtC7Kaleido13SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
